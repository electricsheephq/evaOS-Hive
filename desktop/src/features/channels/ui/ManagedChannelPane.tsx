...
export const ManagedChannelPane = React.memo(function ManagedChannelPane(
  ...
  return (
    <NativeChannelPane
      ...
      onAddAgent={
        !managed && policy.canManageAgents ? props.onAddAgent : undefined
      }
      onBrowseChannels={
        policy.canBrowsePrivateRooms ? props.onBrowseChannels : undefined
      }
      onCreateChannel={
      ...
      onJoinChannel={
        policy.canJoinPublicChannels ? props.onJoinChannel : undefined
      }
