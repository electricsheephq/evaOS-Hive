...
export function managedAuthorityPolicy(
  ...
  return {
    ...
    // Managed mode projects the company Hermes catalog into the canonical
    // Agents route without exposing laptop-local runtime controls.
    canBrowseAgents: !agentOnly,
    canBrowsePrivateRooms: !agentOnly,
    canJoinPublicChannels: !agentOnly,
